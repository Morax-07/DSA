...
namespace DSA {
    ...
    template<typename T> void AVLTree<T>::add(T value) {
        ...
        while(!traversedNodes.isEmpty()) {
            Node* current = traversedNodes.top();
            traversedNodes.pop();
            ...
            if (traversedNodes.isEmpty()) {
                ...
                Node* parent = traversedNodes.top();
    ...
    template<typename T> void AVLTree<T>::remove(T value) {
        ...
        //the node has two children
            ...
            while(successor->left) {
                traversedNodes.push(successorParent);
        ...
        while(!traversedNodes.isEmpty()) {
            //the node to balance is the first of the stack
            Node* current = traversedNodes.top();
            ...
            if(traversedNodes.isEmpty()) {
                ...
                Node* parentBalancing = traversedNodes.top();
